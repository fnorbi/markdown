...
## Algebra
<!-- tk\102\1 -->
26. Egy 1600 Ft-os termék árát a kereskedő 25%-kal felemelte, majd bizonyos idő múlva az új árat 25%-kal csökkentette. Mennyi lett a termék ára a kétszeri árváltoztatás után?
...
16. $f(x)=\sqrt{\cos(x)}$
	...
	a) $\dfrac{1}{2 \sqrt{\cos(x)}} \cdot (-\sin(x))$

	b) $\dfrac{1}{2 \sqrt{x}} \cdot (-\sin(x))$

	c) $\dfrac{1}{2 \sqrt{\cos(x)}} \cdot \cos(x)$

	d) $\dfrac{1}{2 \sqrt{-\sin(x)}}$

17. $f(x)=\sqrt{2e^x-1}$

	a) $\dfrac{1}{2 \sqrt{2e^x-1}} \cdot 2e^x$

	b) $\dfrac{1}{2 \sqrt{x}} \cdot 2e^x$

	c) $\dfrac{1}{2 \sqrt{2e^x-1}} \cdot (2e^x-1)$

	d) $\dfrac{1}{2 \sqrt{2e^x}}$

18. $f(x)=\sqrt{x^2+1}$

	a) $\dfrac{1}{2 \sqrt{x^2+1}} \cdot 2x$

	b) $\dfrac{1}{2 \sqrt{x}} \cdot 2x$

	c) $\dfrac{1}{2 \sqrt{x^2+1}} \cdot (x^2+1)$

	d) $\dfrac{1}{2 \sqrt{2x}}$

19. $f(x)=\ln(\sin(x)+2)$

	a) $\dfrac{1}{\sin(x) + 2} \cdot \cos(x)$
...
20. $f(x)=\cos(\ln(x)-1)$
	...
	c) $-\sin(\ln(x)-1) \cdot (\ln(x) - 1)$

	d) $-\sin\left(\dfrac{1}{x}\right)$

21. $f(x)=4\ln(2-3x)$

	a) $4 \cdot \dfrac{1}{2-3x} \cdot (-3)$

	b) $\dfrac{4}{x} \cdot (-3)$

	c) $4 \cdot \dfrac{1}{2-3x} \cdot (2-3x)$

	d) $\dfrac{4}{2-3x}$
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk1MDA5ODUzOCwtMTQ4NjQzNTIyNCwtMT
YzNzE0MDQ0LDExNjkyNjExMzMsMTczMzMxMjIzMSw3NDg0OTgz
MDAsNjkxNDI2MjU2LDEzNTczOTk5NzUsLTIxMjIyNzg4NzQsOT
EwMjcwMzIsMTYzNjQ1OTY5NSwxNzU4Mzg2ODQzLC0yNjM0NDA4
NzMsLTI3MjY0NTk2LC0xODc3NzI4NzIzLC0xNTU0NjkyNzY1LD
IwMzI2MTE5NTIsLTExOTY3MDkyNCwxMjA2MDM0MjM5LC0yMDgy
NjQ3NTgyXX0=
-->